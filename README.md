...
Configure the host to serve index.html for fallback navigation.
Add production headers matching or extending the headers in server.js.
Replace sample emission factors with region-specific production data if needed.
Accessibility
